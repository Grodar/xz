...
(function($, undefined) {
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			cssSelectorAncestor: ".player_button",
		...
		_updateButtons: function(playing) {
			if(playing !== undefined) {
				...
				if(this.css.jq.play.length && this.css.jq.pause.length) {
					if(playing) {
						this.css.jq.play.css({ opacity: 0.3 });
						this.css.jq.pause.css({ opacity: 1 });
					} else {
						this.css.jq.play.css({ opacity: 1 });
						this.css.jq.pause.css({ opacity: 0.3 });
					}
				}
			}
